...
export interface DB {
  listingsAndReviews: Casa[];  
}

export const db: DB = {
  listingsAndReviews: [
    {
      _id: new ObjectId("65f894f64520ad878ef85eb9"),
    ...
    {
      _id: new ObjectId("65f895055a36ee682ce862b7"),
    ...
    {
      _id: new ObjectId("65f8950bec108ac9a8350fe1"),
    ...
    {
      _id: new ObjectId("65f895124ffd3816c2b2f710"),
    ...
    {
      _id: new ObjectId("65f8951e2f1a0cbd12a8c68d"),
    ...
    {
      _id: new ObjectId("65f8951934fd8bf966d9ce44"),
